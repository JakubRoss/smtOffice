...
namespace smtOffice.Infrastructure.Repository
{
    public class ApprovalRequestRepository : IApprovalRequestRepository
    {
        ...
        public async Task CreateApprovalRequestAsync(ApprovalRequest approvalRequest)
        {
            ...
            cmd.Parameters.AddWithValue("@ApproverID", approvalRequest.ApproverID);
            ...
            cmd.Parameters.AddWithValue("@ApproverID", approvalRequest.ApproverID);
            cmd.Parameters.AddWithValue("@LeaveRequestID", approvalRequest.LeaveRequestID);
            cmd.Parameters.AddWithValue("@Status", approvalRequest.Status ?? (object)DBNull.Value);
            cmd.Parameters.AddWithValue("@Comment", approvalRequest.Comment ?? (object)DBNull.Value);
        ...
        public async Task UpdateApprovalRequestAsync(ApprovalRequest approvalRequest)
        {
            ...
            using var cmd = new SqliteCommand(sql, connection);
            cmd.Parameters.AddWithValue("@ID", approvalRequest.ID);
            cmd.Parameters.AddWithValue("@ApproverID", approvalRequest.ApproverID);
            cmd.Parameters.AddWithValue("@LeaveRequestID", approvalRequest.LeaveRequestID);
            cmd.Parameters.AddWithValue("@Status", approvalRequest.Status ?? (object)DBNull.Value);
            cmd.Parameters.AddWithValue("@Comment", approvalRequest.Comment ?? (object)DBNull.Value);
